...
--------------------------------------------------
Nuage VSP Domain Template Support
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Overview
~~~~~~~~

VSP's CloudStack plugin can be configured to use a VSP Domain Template when instantiating (Isolated or VPC) Networks. The parameters and abstractions contained in the template are reused every time a new network is created in CloudStack, and thus all the constructs defined in the template are available in the created resource. 
...
To configure a VSP domain template for use by CloudStack, use the global CloudStack parameters listed above.
